...
?>
        array(
            ...
            'htmlOptions' => array(),
            <?php if(strtolower($column->name)=='estatus'): ?>
            'value' => 'strtr($data->estatus,array("A"=>"Activo", "I"=>"Inactivo", "E"=>"Eliminado"))',
            'filter' => array('A' => 'Activo', 'I' => 'Inactivo', 'E' => 'Eliminado'),
            <?php elseif($column->name=='origen'): ?>
            'value' => 'strtr($data->origen,array("V"=>"Venezolano", "E"=>"Extranjero", "P"=>"Pasaporte"))',
...
?>
        array(
            'header' => '<center><?php echo ucwords($column->name); ?></center>',
            'name' => '<?php echo $column->name; ?>',
            'htmlOptions' => array(),
            'filter' => CHtml::textField('<?php echo $this->getModelClass(); ?>[<?php echo $column->name; ?>]', $model-><?php echo $column->name; ?>, array('title' => '',)),
        ),
...
<?php echo "<?php\n"; ?>
     ...
     *   Yii::app()->request->baseUrl . '/public/js/modules/miModulo/<?php echo $this->getControllerClass(); ?>/<?php echo $this->class2id($this->modelClass); ?>/admin.js', CClientScript::POS_END
     *);
     */
<?php echo "?>"; ?>
