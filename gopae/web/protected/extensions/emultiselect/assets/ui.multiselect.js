...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.availableActions = $('<div class="actions ui-widget-header ui-helper-clearfix"><input type="text" class="search empty ui-widget-content ui-corner-all" style="width:200px; height:20px" placeholder="Ingrese Busqueda"/><a href="#" class="add-all">'+$.ui.multiselect.locale.addAll+'</a></div>').appendTo(this.availableContainer);
...
$.extend($.ui.multiselect, {
	locale: {
		...
		itemsCount:'Opciones Seleccionadas'
	}
});
