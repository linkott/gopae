...
<html lang="es">
    <head>
        <meta charset="utf-8" />
        <title>Error | Sistema de Gestión Operativa del CNAE</title>

        <meta name="description" content="Gestión Escolar - Inicio" />
        ...
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/public/js/jquery/2.0.3/jquery.min.js"></script>
    ...
    <body class="login-layout">
        ...
        <div class="main-container" id="main-container">
            ...
            <div class="page-content">
                ...
                <div class="row center">
                    <a class="btn btn-primary" href="<?php echo (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : '/site'; ?>" id="btnRegresar">
        ...
        <footer id="footer" class="main-container" style="margin-top: 430px;">
            <div class="mein-container-inner">
