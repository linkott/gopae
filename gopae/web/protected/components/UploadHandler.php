...
class UploadHandler {
    ...
    /**
     * Constructor de la clase uploadHandler
     * 
     * @param array $options opciones de del fileUploader predefinido
     * @param bool $initialize indica si inicia automaticamente la carga o cualquier otra accion sobre un archivo
     * @param array $error_messages arreglo de mensajes de error predefinido
     * @param string $filename nombre con que se cargara el archivo
     * @param string $upload_url ruta del directorio donde se cargara el archivo predefinido
     * @param int $id_model id opcional
     */
    function __construct($options = null, $initialize = true, $error_messages = null, $filename = null, $upload_url = '/public/uploads/', $id_model = '') {
        $this->options = array(
            'script_url' => $this->get_full_url() . '/uploads',
            ...
            'image_versions' => array(
                ...
                'thumbnail' => array(
                    ...
                    'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')) . $upload_url . 'thumbnail',
                    'upload_url' => $this->get_full_url() . $upload_url . 'thumbnail',
        ...
        if ($id_model != null) {
            $this->filename = $this->filename . $this->id_model;
        }
...
//        var_dump($file->name);
    ...
    public function deleteOneByFileName($file_name, $print_response = true) {
        $response = array();
