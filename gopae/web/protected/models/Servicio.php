...
/**
 * This is the model class for table "gplantel.servicio".
 *
 * The followings are the available columns in table 'gplantel.servicio':
 * @property integer $id
...
class Servicio extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            'servicioPlantels' => array(self::HAS_MANY, 'ServicioPlantel', 'servicio_id'),
    ...
    public function getServicios($ids = array()) {
        
        $servicios = array();
        $sql = "SELECT id, nombre 
                FROM gplantel.servicio
                ";
        if($ids !== array()){
            $ids = implode(',', $ids);
