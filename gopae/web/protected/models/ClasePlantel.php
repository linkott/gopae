...
/**
 * This is the model class for table "gplantel.clase_plantel".
 *
 * The followings are the available columns in table 'gplantel.clase_plantel':
 * @property integer $id
 ...
 */
class ClasePlantel extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'plantels' => array(self::HAS_MANY, 'Plantel', 'clase_plantel_id'),
	 ...
	 * @return ClasePlantel the static model class
	 */
