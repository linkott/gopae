...
/**
 * This is the model class for table "diversidad_funcional".
 *
 * The followings are the available columns in table 'diversidad_funcional':
 * @property integer $id
 ...
 */
class DiversidadFuncional extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id', 'required'),
			array('id, usuario_ini_id, usuario_act_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, nombre, abreviatura, usuario_ini_id, fecha_ini, usuario_act_id, fecha_act, fecha_elim, estatus', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		if(strlen($this->abreviatura)>0) $criteria->compare('abreviatura',$this->abreviatura,true);
	 ...
	 * @return DiversidadFuncional the static model class
	 */
