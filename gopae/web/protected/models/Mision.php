...
/**
 * This is the model class for table "mision".
 *
 * The followings are the available columns in table 'mision':
 * @property integer $id
 ...
 */
class Mision extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('nombre, usuario_ini_id', 'required'),
	 ...
	 * @return Mision the static model class
	 */
