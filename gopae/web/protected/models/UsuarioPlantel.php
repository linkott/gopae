...
/**
 * This is the model class for table "gplantel.usuario_plantel".
 *
 * The followings are the available columns in table 'gplantel.usuario_plantel':
 * @property string $id
 ...
 */
class UsuarioPlantel extends CActiveRecord
{
	/**
	...
	{
		return 'gplantel.usuario_plantel';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('plantel_id, usuario_id, cargo_id, usuario_ini_id, usuario_act_id', 'numerical', 'integerOnly'=>true),
			array('observacion', 'length', 'max'=>150),
			array('estatus', 'length', 'max'=>1),
			array('fecha_act, fecha_elim', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, plantel_id, usuario_id, cargo_id, observacion, usuario_ini_id, fecha_ini, usuario_act_id, fecha_act, fecha_elim, estatus', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return UsuarioPlantel the static model class
	 */
