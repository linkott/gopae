...
/**
 * This is the model class for table "gplantel.eponimo".
 *
 * The followings are the available columns in table 'gplantel.eponimo':
 * @property integer $id
 ...
 */
class Eponimo extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'plantels' => array(self::HAS_MANY, 'Plantel', 'eponimo_id'),
	 ...
	 * @return Eponimo the static model class
	 */
