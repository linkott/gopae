 ...
 *
 * The followings are the available columns in table 'grado_instruccion':
 * @property integer $id
 ...
 */
class GradoInstruccion extends CActiveRecord
{
	/**
	 ...
	 * @return GradoInstruccion the static model class
	 */
