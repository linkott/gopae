...
/**
 * This is the model class for table "administrativo.tipo_pago".
 *
 * The followings are the available columns in table 'administrativo.tipo_pago':
 * @property integer $id
...
class TipoPago extends CActiveRecord
{
	...
	{
		return 'administrativo.tipo_pago';
	}
