...
/**
 * This is the model class for table "administrativo.tipo_sector".
 *
 * The followings are the available columns in table 'administrativo.tipo_sector':
 * @property integer $id
 ...
 */
class TipoSector extends CActiveRecord
{
	/**
	...
	{
		return 'administrativo.tipo_sector';
	}
	 ...
	 * @return TipoSector the static model class
	 */
