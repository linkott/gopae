...
/**
 * This is the model class for table "gplantel.dependencia_nominal".
 *
 * The followings are the available columns in table 'gplantel.dependencia_nominal':
 * @property integer $id
 ...
 */
class DependenciaNominal extends CActiveRecord
{
	/**
	...
	{
		return 'gplantel.dependencia_nominal';
	}
	...
	public function relations()
	{
		...
		return array(
			'plantels' => array(self::HAS_MANY, 'Plantel', 'dependencia_nominal_id'),
...
{
    /*CREO EL QUERY*/
    $sql = "UPDATE dependencia_nominal SET nombre=$nombre WHERE id=$id";
	 ...
	 * @return DependenciaNominal the static model class
	 */
