...
/**
 * This is the model class for table "gplantel.tenencia_plantel".
 *
 * The followings are the available columns in table 'gplantel.tenencia_plantel':
 * @property integer $id
 ...
 */
class TenenciaPlantel extends CActiveRecord
{
	/**
	...
	{
		return 'gplantel.tenencia_plantel';
	}
	 ...
	 * @return TenenciaPlantel the static model class
	 */
