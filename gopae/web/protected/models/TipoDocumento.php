...
/**
 * This is the model class for table "proveduria.tipo_documento".
 *
 * The followings are the available columns in table 'proveduria.tipo_documento':
 * @property integer $id
 ...
 * @property DocumentoProveedor[] $documentoProveedors
...
class TipoDocumento extends CActiveRecord
{
	...
	{
		return 'proveduria.tipo_documento';
	}
	...
	public function relations()
	{
		...
		return array(
			'documentoProveedors' => array(self::HAS_MANY, 'DocumentoProveedor', 'tipo_documento_id'),
