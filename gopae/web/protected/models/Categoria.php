...
/**
 * This is the model class for table "gplantel.categoria".
 *
 * The followings are the available columns in table 'gplantel.categoria':
 * @property integer $id
...
class Categoria extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'plantels' => array(self::HAS_MANY, 'Plantel', 'categoria_id'),
