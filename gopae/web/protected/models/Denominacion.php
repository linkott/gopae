...
/**
 * This is the model class for table "gplantel.denominacion".
 *
 * The followings are the available columns in table 'gplantel.denominacion':
 * @property integer $id
 ...
 */
class Denominacion extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'plantels' => array(self::HAS_MANY, 'Plantel', 'denominacion_id'),
