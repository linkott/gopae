...
/**
 * This is the model class for table "nutricion.tipo_articulo".
 *
 * The followings are the available columns in table 'nutricion.tipo_articulo':
 * @property integer $id
...
class TipoArticulo extends CActiveRecord
{
	...
	{
		return 'nutricion.tipo_articulo';
	}
	...
	public function relations()
	{
		...
		return array(
			'articulos' => array(self::HAS_MANY, 'Articulo', 'tipo_articulo_id'),
