...
/**
 * This is the model class for table "gplantel.estatus_plantel".
 *
 * The followings are the available columns in table 'gplantel.estatus_plantel':
 * @property integer $id
 ...
 */
class EstatusPlantel extends CActiveRecord
{
	/**
	...
	{
		return 'gplantel.estatus_plantel';
	}
	 ...
	 * @return EstatusPlantel the static model class
	 */
