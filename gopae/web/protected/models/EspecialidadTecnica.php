...
/**
 * This is the model class for table "gplantel.especialidad_tecnica".
 *
 * The followings are the available columns in table 'gplantel.especialidad_tecnica':
 * @property integer $id
 ...
 */
class EspecialidadTecnica extends CActiveRecord
{
	/**
	...
	{
		return 'gplantel.especialidad_tecnica';
	}
	...
	public function relations()
	{
		...
		return array(
			'plantels' => array(self::HAS_MANY, 'Plantel', 'especialidad_tec_id'),
	 ...
	 * @return EspecialidadTecnica the static model class
	 */
