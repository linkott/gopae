...
/**
 * This is the model class for table "servicio.utensilio".
 *
 * The followings are the available columns in table 'servicio.utensilio':
 * @property integer $id
 ...
 */
class Utensilio extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'servicio.utensilio';
    }
     ...
     * @return Utensilio the static model class
     */
