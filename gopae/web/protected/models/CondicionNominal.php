...
/**
 * This is the model class for table "gestion_humana.condicion_nominal".
 *
 * The followings are the available columns in table 'gestion_humana.condicion_nominal':
 * @property integer $id
 ...
 * @property TipoCargoNominal[] $tipoCargoNominals
 * @property UsergroupsUser $usuarioIni
 * @property UsergroupsUser $usuarioAct
 */
class CondicionNominal extends CActiveRecord
{
	/**
	...
	{
		return 'gestion_humana.condicion_nominal';
	}
	...
	public function relations()
	{
		...
		return array(
			'talentoHumanos' => array(self::HAS_MANY, 'TalentoHumano', 'condicion_actual_id'),
			'tipoCargoNominals' => array(self::HAS_MANY, 'TipoCargoNominal', 'condicion_id'),
        ...
        public function beforeUpdate()
	{
        ...
        public function __toString() {
            try {
                return (string) $this->nombre.' ('.$this->siglas.')';
	 ...
	 * @return CondicionNominal the static model class
	 */
