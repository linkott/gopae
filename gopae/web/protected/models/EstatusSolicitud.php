...
/**
 * This is the model class for table "titulo.estatus_solicitud".
 *
 * The followings are the available columns in table 'titulo.estatus_solicitud':
 * @property integer $id
...
class EstatusSolicitud extends CActiveRecord
{
	...
	{
		return 'titulo.estatus_solicitud';
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'nombre' => 'Nombre de la estatus de la solicitud.',
