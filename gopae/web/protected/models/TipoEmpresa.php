...
/**
 * This is the model class for table "administrativo.tipo_empresa".
 *
 * The followings are the available columns in table 'administrativo.tipo_empresa':
 * @property integer $id
...
class TipoEmpresa extends CActiveRecord
{
	...
	{
		return 'administrativo.tipo_empresa';
	}
