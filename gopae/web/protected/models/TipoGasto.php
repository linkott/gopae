...
/**
 * This is the model class for table "presupuesto.tipo_gasto".
 *
 * The followings are the available columns in table 'presupuesto.tipo_gasto':
 * @property integer $id
...
class TipoGasto extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'partidas' => array(self::HAS_MANY, 'Partida', 'tipo_gasto_id'),
