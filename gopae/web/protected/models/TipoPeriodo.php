...
/**
 * This is the model class for table "gplantel.tipo_periodo".
 *
 * The followings are the available columns in table 'gplantel.tipo_periodo':
 * @property integer $id
 ...
 */
class TipoPeriodo extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'nivels' => array(self::HAS_MANY, 'Nivel', 'tipo_periodo_id'),
	 ...
	 * @return TipoPeriodo the static model class
	 */
