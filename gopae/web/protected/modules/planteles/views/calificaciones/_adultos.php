...
<div class = "widget-box">
    ...
    <div class = "widget-header">
        <h5>Evaluación <?php echo '"' . $datosEstudiante[0]['nombres'] . ' ' . $datosEstudiante[0]['apellidos'] . '"'.' Semestre '.  base64_decode($lapso); ?></h5>
        ...
        <div class = "widget-body-inner">
            <div class = "widget-main">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div id="respuestaRegistro"  class="alert alert-block hide">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'dataProvider' => AsignaturaEstudiante::model()->obtenerAsignaturasEstudianteAdultosGrid($id,$lapso),
                            'summaryText' => false,
                            'pager' => array(
                                'header' => '',
