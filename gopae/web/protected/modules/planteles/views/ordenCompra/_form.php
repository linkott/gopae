        ...
        <div class="tab-content">
            <div id="datosGenerales" class="tab-pane active">
                ...
                if ($estatus == "sin-pae-act") {
                    ...
                    $this->renderPartial("//msgBox", array('class' => 'alertDialogBox', 'message' => 'Este plantel ya tiene una orden de compra elaborada durante este mes.'));
                } elseif ($estatus == "mes-menor") {
                    $this->renderPartial("//msgBox", array('class' => 'alertDialogBox', 'message' => 'Solo se pueden realizar ordenes de compra durante los meses posteriores al actual.'));
                 } elseif ($estatus == "sin-matricula") {
                    $this->renderPartial("//msgBox", array('class' => 'alertDialogBox', 'message' => 'Este plantel no tiene Matricula.'));
                } elseif ($estatus == "sin-tipo-servicio") {
                    $this->renderPartial("//msgBox", array('class' => 'alertDialogBox', 'message' => 'Este plantel no tiene un tipo de servicio asignado (Insumo o Plato servido).'));
                    ...
                    <div class="widget-box">
                        <div class="widget-header">
                            <h5>Datos de Orden de Compra  <?php $meses = Utiles::getMeses(); echo $meses[$mes]." de ".$ano;  ?></h5>
                            ...
                            <div class="widget-main form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-12">
                                            <?php echo "<span class='datos-form'>" . $datos_plantel[0]["plantel_nombre"] . "</span>"; ?>
                                            <?php echo "<input id ='dependencia' type='hidden' name='OrdenCompra[dependencia]' value = '" . $datos_plantel[0]["plantel_id"] . "' />"; ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            if ($datos_plantel[0]["proveedor_nombre"] != null) {
                                                echo "<span class='datos-form'>" . $datos_plantel[0]["proveedor_nombre"] . "</span>";
                                                echo "<input type='hidden' name='OrdenCompra[proveedor_id]' value = '" . $datos_plantel[0]["proveedor_id"] . "' />";
                                            } else {
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-12">
                                            <?php
                                            if ($datos_plantel[0]["zona_nombre"] != null) {
                                                echo "<span class='datos-form'>" . "ZONA EDUCATIVA " . $datos_plantel[0]["zona_nombre"] . "</span>";
                                                echo "<input type='hidden' name='OrdenCompra[unidad_administradora]' value = '" . $datos_plantel[0]["zona_id"] . "' />";
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            if ($datos_plantel[0]["zona_nombre"] != null) {
                                                echo "<span class='datos-form'>" . "ZONA EDUCATIVA " . $datos_plantel[0]["zona_nombre"] . "</span>";
                                                echo "<input type='hidden' name='OrdenCompra[unidad_ejecutora_local]' value = '" . $datos_plantel[0]["zona_id"] . "' />";
                                            } else {
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-12">
                                            <?php echo "<span class='datos-form'>" . $datos_plantel[0]["estado"] . "</span>"; ?>
                                            <?php echo "<input type='hidden' name='OrdenCompra[estado]' value = '" . $datos_plantel[0]["estado"] . "' />"; ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-12">
                                            <?php echo "<span class='datos-form'>" . $datos_plantel[0]["municipio"] . "</span>"; ?>
                                            <?php echo "<input type='hidden' name='OrdenCompra[municipio]' value = '" . $datos_plantel[0]["municipio"] . "' />"; ?>
                                            <?php echo $form->error($model, 'codigo'); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                    ...
                    <div class="row" >
                        ...
                        if ($datos_plantel[0]["tipo_servicio"] == 1) {
                            $this->widget('zii.widgets.grid.CGridView', array(
                                ...
                                'dataProvider' => $model->listadoPlanificacion($plantel_id,$mes,$ano,$datos_plantel[0]["tipo_menu"]),
                                'summaryText' => false,
                                'pager' => array(
                                    'header' => '',
