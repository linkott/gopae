<div class="col-md-12">
    <div class="widget-box collapsed">
        ...
        <div class="widget-header">
            <h5>Plantel <?php echo '"' . $plantel['nombre_plantel'] . '"'; ?></h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-4" >
                                    ...
                                    <?php echo CHtml::textField('', '', array('class' => 'span-12', 'readOnly' => 'readOnly', 'disabled'=>'disabled')); ?>
                                </div>
                                ...
                                <div class="col-md-4" >
                                    ...
                                    <?php echo CHtml::textField('', '', array('class' => 'span-7', 'readOnly' => 'readOnly', 'disabled'=>'disabled')); ?>
                                </div>
                            </div>
