...
?>
	...
	<div class="col-sm-4">
            ...
            <?php
            echo $form->dropDownList(
                    $model, 'condicion_servicio_id', CHtml::listData(CCondicionServicio::getData(), 'id', 'nombre'  ), array('empty' => array('' => '- SELECCIONE -'), 'class' => 'span-12', 'disabled' => 'disabled')
            );
            ?>
	</div>
...
//            var_dump($model->id);
	...
	<div class="col-sm-4">
            ...
            <?php
            echo $form->dropDownList(
                    $model, 'posee_area_cocina', CHtml::listData(array(array('id' => 'SI', 'nombre' => 'SI'), array('id' => 'NO', 'nombre' => 'NO')), 'id', 'nombre'  ), array('class' => 'span-12', 'disabled' => 'disabled')
            );
            ?>
	</div>
	...
	<div class="col-sm-4">
            ...
            <?php
            echo $form->dropDownList(
                    $model, 'posee_area_produccion_agricola', CHtml::listData(array(array('id' => 'SI', 'nombre' => 'SI'), array('id' => 'NO', 'nombre' => 'NO')), 'id', 'nombre'  ), array('class' => 'span-12', 'disabled' => 'disabled')
            );
            ?>
	</div>
