        ...
        <tr>
            ...
            <td>
                <?php   
                    ...
                    {
                        echo $model->zonaEducativa->nombre;
                    }
                ?>
            </td>
            <td><b>Tipo de dependencia</b></td>
            <td>
                <?php   
                    if(!empty($model->tipo_dependencia_id))
                    {
                        echo $model->tipoDependencia->nombre;
                    }
                ?>
            </td>
        </tr>
...
<br>
    ...
    <table style="font-size:11px; width:800px;">
        ...
        <tr>
            ...
            <td><b>Tipo ubicaci&oacute;n</b></td>
            <td>
                <?php
                $resultado = Plantel::model()->obtenerTipoUbicacion(base64_decode($_GET['id']));
...
<br>
    ...
    <table style="font-size:11px; width:800px;">
        ...
        <tr>
            <td colspan="4" align="center" style="background:#E5E5E5; padding:5px;">
                <b>COORDENADAS GEOGR&Aacute;FICAS</b>
            </td>
        </tr>

        <tr>
            <td width="10%"><b>Longitud</b></td>
            <td width="20%">
                <?php echo $model->longitud;?>
            </td>
            <td width="10%"><b>Latitud</b></td>
            <td width="40%">
                <?php echo $model->latitud;?>
            </td>
        </tr>
