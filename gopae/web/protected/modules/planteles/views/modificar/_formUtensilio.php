...
//                            var_dump(CTipoMenu::getData());die();
                            ...
                            echo $form->dropDownList(
                                $model, 'id', CHtml::listData(Articulo::model()->findAll(array('condition' => 'tipo_articulo_id = 2')), 'id', 'nombre'), array('empty' => '- - -', 'class' => 'col-sm-4', 'id' => 'utensilio_id')
                            );
...
//                                        ),
                                ...
                                array(
                                    ...
                                    'value' => array($this, 'columnaAccionesUtensilio'),
