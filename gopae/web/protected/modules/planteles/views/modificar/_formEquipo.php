...
//                            var_dump(CTipoMenu::getData());die();
                            $form = $this->beginWidget('CActiveForm', array(
                                'id' => 'plantel-pae-articulo-form',
                                'enableAjaxValidation' => true,
                            ));

                            echo $form->dropDownList(
                                $model, 'id', CHtml::listData(Articulo::model()->findAll(array('condition' => 'tipo_articulo_id = 3')), 'id', 'nombre'), array('empty' => '- - -', 'class' => 'col-sm-4')
                            );
...
//                                        ),
                                ...
                                array(
                                    ...
                                    'value' => array($this, 'columnaAccionesEquipo'),
...
<div id="dialogPantallaEliminar" class="hide"> 
    <div class="alertDialogBox bigger-110">
        <p class="bigger-110 bolder center grey">
            &iquest;Estas seguro de eliminar este Equipo?
        </p>
    </div>
</div>

<?php
    Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . '/public/js/modules/plantel/equipo.js', CClientScript::POS_END);
?>
