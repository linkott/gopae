...
<div class="tabbable">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="pae">
            <?php
            $this->renderPartial('_formPlantelPae', array('plantel_id' => $model->id, 'model' => $modelPlantelPae, 'fechaIniMatricula' => $fechaIniMatricula, 'fechaFinMatricula' => $fechaFinMatricula));
            ?>
        </div>

        <div class="tab-pane" id="ingesta">
            <?php
            $this->renderPartial('_formIngesta', array('plantel_id' => $model->id, 'model' => $modelIngesta));
            ?>
        </div>
