...
list($codigo_plantel, $cedula_estudiante, $nombre_estudiante, $apellido_estudiante) = explode(";", $model->descripcion);
...
<table>
        ...
        <td>
            <div class="profile-info-row">
                <div class="profile-user-info profile-user-info-striped" style="height:60px;">
                    ...
                    <div class="profile-info-value">
                        <span id="nombre_zona"> <?php echo CHtml::encode($codigo_plantel); ?></span>
                    </div>
                </div>
            </div>
        </td>
    ...
    <tr>
        <td>
            ...
            <div class="profile-info-row">
                <div class="profile-user-info profile-user-info-striped">
                    <div class="profile-info-name"><b><i>Cedula del Estudiante</i></b></div>
                    <div class="profile-info-value">
                        <span id="estado"><i><?php echo CHtml::encode($cedula_estudiante); ?> </i></span>
                    </div>
                </div>
            </div>
    ...
    <tr>
        <td>
            ...
            <div class="profile-info-row">
                <div class="profile-user-info profile-user-info-striped" style="height:60px;">
                    <div class="profile-info-name"><b><i>Nombre del Estudiante</i></b></div>
                    <div class="profile-info-value">
                        <span id="estado"><?php echo CHtml::encode($nombre_estudiante); ?></span>
                    </div>
                </div>
            </div>
    ...
    <tr>
        <td>
            <div class="profile-info-row">
                <div class="profile-user-info profile-user-info-striped" style="height:60px;">
                    <div class="profile-info-name"><b><i>Apellido del Estudiante</i></b></div>
                    <div class="profile-info-value">
                        <span id="estado"> <?php echo CHtml::encode($apellido_estudiante); ?> </span>
                    </div>
                </div>
            </div>
