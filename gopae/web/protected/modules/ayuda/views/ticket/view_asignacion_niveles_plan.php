...
list($niveles, $plan) = explode(";", $model->descripcion);
...
<table>
        ...
        <td>
            <div class="profile-info-row">
                <div class="profile-user-info profile-user-info-striped" style="height:60px;">
                    <div class="profile-info-name"><b><i>niveles</i></b></div>
                    <div class="profile-info-value">
                        <span id="nombre_zona"> <?php echo CHtml::encode($niveles); ?></span>
                    </div>
                </div>
            </div>
        </td>
    ...
    <tr>
        <td>
            ...
            <div class="profile-info-row">
                <div class="profile-user-info profile-user-info-striped">
                    <div class="profile-info-name"><b><i>Plan</i></b></div>
                    <div class="profile-info-value">
                        <span id="estado"><i><?php echo CHtml::encode($plan); ?> </i></span>
                    </div>
                </div>
            </div>
