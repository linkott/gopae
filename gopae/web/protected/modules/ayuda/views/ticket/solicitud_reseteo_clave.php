...
<?php foreach ($resultado as $r) { ?>
    ...
    <table>
        ...
        <?php
        list($cedula, $solicitante, $correo, $celular) = explode(";", $r['descripcion']);
        ?>
        <tr>
            <td>
        ...
        <tr>
            <td>
                ...
                <div class="profile-info-row">
                    <div class="profile-user-info profile-user-info-striped">
                        ...
                        <div class="profile-info-value">
                            <span id="estado"><?php echo $correo; ?></span>
                        </div>
                    </div>
                </div>
            ...
            <td>
                <div class="profile-info-row">
                    <div class="profile-user-info profile-user-info-striped">
                        <div class="profile-info-name"><b><i>Telefono Celular</i></b></div>
                        <div class="profile-info-value">
            ...
            <td>
                <div class="profile-info-row">
                    <div class="profile-user-info profile-user-info-striped">
                        ...
                        <div class="profile-info-value">
                            <span id="estado"> <?php echo $r['observacion']; ?> </span>
                        </div>
                    </div>
