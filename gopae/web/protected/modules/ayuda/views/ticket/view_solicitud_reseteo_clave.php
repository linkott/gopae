...
<?php
    list($cedula, $solicitante, $correo) = explode(";", $model->descripcion);
?>
<?php
        ...
        <td>
            <div class="profile-info-row">
                <div class="profile-user-info profile-user-info-striped">
                    ...
                    <div class="profile-info-value">
                        <span id="estado"><?php echo CHtml::encode($correo); ?></span>
                    </div>
                </div>
            </div>
        </td>
        ...
        <td>
            <div class="profile-info-row">
                <div class="profile-user-info profile-user-info-striped">
                    ...
                    <div class="profile-info-value">
                        <span id="nombre_zona">  <?php echo CHtml::encode($necesidad); ?> </span>
                    </div>
                </div>
        </td>
    </tr>
