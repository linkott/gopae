<h1 class="closed" onclick="$(this).toggleClass('opened').nextAll('.hidden-pannell').first().slideToggle();"><?php echo Yii::t('userGroupsModule.admin', 'Main Configurations'); ?></h1>
<?php if(Yii::app()->user->hasFlash('configuration')):?>
    <div class="info">
        <?php echo Yii::app()->user->getFlash('configuration'); ?>
    </div>
<?php endif; ?>
<div class="hidden-pannell">
	<?php 
