...
<div id="userGroups-container">
	...
	<?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'columns'=>array(
			...
			array(
				'name'=>'region',
				'value'=>'UserGroupsLookup::resolveRegion("id_region",$data->region)',
				'visible'=>Yii::app()->user->pbac('userGroups.user.admin'),
				'filter' => CHtml::dropDownList('UserGroupsUser[region]', $model->region, array_merge(array('null' => Yii::t('userGroupsModule.admin','all')), CHtml::listData(Region::model()->findAll(), 'id_region', 'descripcion')) ),
