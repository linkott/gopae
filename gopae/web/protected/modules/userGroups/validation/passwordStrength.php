		...
		switch ((int)$strength) {
			case self::WEAK:
				if ($this->user_id === UserGroupsUser::ROOT) {
					...
					$array['message'] = 'La Clave de Root debe contener al menos 2 digitos numéricos y 2 letras y contener al menos 5 caracteres.';
				} else {
					$array['pattern'] = $this->weak_pattern;
					$array['message'] = 'La Clave debe contener al menos 5 caracteres.';
				}
				break;
			case self::MEDIUM:
				$array['pattern'] = $this->medium_pattern;
			...
			case self::STRONG:
				...
				$array['message'] = 'La Clave de Root debe contener al menos 2 digitos numéricos, 2 letras y 1 caracter especial (*,&,%,@,$...) y contener al menos 5 caracteres.';
				break;
		}
		return $array;
	}
