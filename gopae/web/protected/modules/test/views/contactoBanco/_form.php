...
<div class="col-xs-12">
    <div class="row-fluid">
                        ...
                        <div id="div-datos-generales">
                            ...
                            <div class="widget-box">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a class="btn btn-danger" href="<?php echo $this->createUrl("/test/contactoBanco"); ?>" id="btnRegresar">
        ...
        <?php
             ...
             *   Yii::app()->request->baseUrl . '/public/js/modules/miModulo/ContactoBancoController/contacto-banco/form.js',CClientScript::POS_END
             *);
             */
        ?>
    </div>
