...
$this->pageTitle = "Consulta de Registro Único de Planteles";
    ...
    <div class="widget-box collapsed">
        ...
        <div class="widget-header">
            ...
            <div class="widget-toolbar">
                <a id="lnkBusquedaAvanzadaRegUnicPlantelesPae" href="#" data-action="collapse">
                ...
                <div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-right">
                            <a href="/registroUnico/plantelesPae/nuevoRegistro" class="btn btn-sm btn-success">
                    ...
                    //director_actual_id
                    $autoridadPlantel = array('header' => '<center title="Matricula Total">Director Registrado</center>',
                        'name' => 'tiene_director_registrado',
                        'value' => '(is_numeric($data->director_actual_id))?"Sí":"No"',
                        'filter' => CHtml::listData(array(array('id'=>'SI', 'nombre'=>'Si'),array('id'=>'NO', 'nombre'=>'No')), 'id', 'nombre'),
                    );
                    ...
                    $this->widget('zii.widgets.grid.CGridView', array(
                        ...
                        'id' => 'plantel-grid',
                        'dataProvider' => $dataProviderPlanteles,
                        'filter' => $model,
...
<script>
    $(document).ready(function(){
        $.gritter.add({
            ...
            text: 'Todo Plantel Con Código DEA debe ser registrado así este sea un NER. Ejemplo: Si se presentara 1 solo director para 10 NERs con diferente código DEA, cada uno debe ser registrado con su matrícula y datos CNAE.<br><br>Cuando hablamos de sedes distantes nos referimos a que diferentes plantas físicas (distantes) pertenecientes a un mismo plantel con el mismo Código DEA.',
            class_name: 'gritter-warning',
            time: 40000
        });
    });
</script>
<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . '/public/js/modules/plantel/consultarPlantel.js',CClientScript::POS_END);?>
