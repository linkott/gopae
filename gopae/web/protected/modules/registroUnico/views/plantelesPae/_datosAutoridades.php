...
<form id="form-autoridad-plantel">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="telf_cel"  id="telf_cel" style="width: 90%;"  maxlength="11" value="<?php echo str_pad($modelAutoridad['telefono_celular'], 11, '0', STR_PAD_LEFT); ?>" />
                                        <input id="telf_celBackup" name="telf_celBackup" type="hidden" style="width: 90%;" value="<?php echo str_pad($modelAutoridad['telefono_celular'], 11, '0', STR_PAD_LEFT); ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row-fluid">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="telf_fijo" id="telf_fijo" style="width: 90%;" maxlength="11" value="<?php echo str_pad($modelAutoridad['telefono'], 11, '0', STR_PAD_LEFT); ?>" />
                                        <input id="telf_fijoBackup" name="telf_fijoBackup" type="hidden" style="width: 90%;" value="<?php echo str_pad($modelAutoridad['telefono'], 11, '0', STR_PAD_LEFT); ?>" />
                                    </div>
                                </div>
                                <div class="col-md-6">
...
//                                                    (Cargo::model()->getCargoAutoridad(), 'id', 'nombre'), array('empty' => 'Seleccione', 'id' => 'cargo_id_autoridad', 'class' => 'span-7'));
                                    ?>
                                    <input id="cargo_idBackup" name="cargo_idBackup" type="text"  readOnly = "readOnly" style="width: 90%;" value="<?php echo $modelAutoridad['cargo']; ?>" />
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row-fluid">
                                <div class="col-md-12">
                                    <label for="Editar_presento_documento_identidad">Presentó el Documento de Identidad<span class="required">*</span></label>
                                    <select id="Editar_presento_documento_identidad" name="presento_documento_identidad" class="span-12">
                                        <option>- - -</option>
                                        <option <?php if($modelAutoridad['presento_documento_identidad']=='SI'): echo 'selected'; endif; ?> value="SI">Sí</option>
                                        <option value="NO">No</option>
                                    </select>
                                    <input id="presento_documento_identidad_backup" name="presento_documento_identidad_backup" type="hidden" value="<?php echo htmlentities($modelAutoridad['presento_documento_identidad']); ?>" />
                                </div>
                            </div>
                            ...
                            <input type="hidden" style="display: none;" id="plantel_id" name="plantel_id" value="<?php echo base64_encode($modelAutoridad['plantel_id']); ?>">
