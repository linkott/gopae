                ...
                <div class="widget-main">
                    ...
                    <div style="display:block" class="search-form">
                        <div class="widget-main form">
                            ...
                            <?php
                            $utensilio = TipoArticulo::model()->findAll(array('condition' => "nombre ILIKE 'UTENSILIO'"));
                            $utensilio = $utensilio[0]['id'];
                            ?>
                            <input type="hidden" id='Articulo_tipo_articulo_id' name="Articulo_tipo_articulo_id" value="<?php echo $utensilio; ?>" />

                            <div class="row">
                                <div class="col-md-6">
                                    Nombre del Utensilio <span class="required">*</span>
                                    <br>
