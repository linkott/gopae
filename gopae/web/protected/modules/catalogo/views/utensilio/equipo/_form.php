                ...
                <div class="widget-main">
                    ...
                    <div style="display:block" class="search-form">
                        <div class="widget-main form">
                            ...
                            <?php
                            $alimento = TipoArticulo::model()->findAll(array('condition' => "nombre ILIKE 'ALIMENTO'"));
                            $alimento = $alimento[0]['id'];
                            ?>
                            <input type="hidden" id='Articulo_tipo_articulo_id' name="Articulo_tipo_articulo_id" value="<?php echo $alimento; ?>" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 hidden" id="franja">
