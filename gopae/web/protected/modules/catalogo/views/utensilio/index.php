        ...
        <div class="widget-body-inner" style="display: block;">
            <div class="widget-main">
                ...
                <div style="padding-left:10px;" class="pull-right">
                    <a class="btn btn-success btn-next btn-sm" data-last="Finish" href="#" onclick="registrarArticulo('utensilio');">
                        <i class="fa fa-plus icon-on-right"></i>
                        Registrar nuevo utensilio
                    </a>
                </div>
                ...
                <div style="display:block" class="search-form">
                    <div>
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'id' => 'articulo-grid',
                            'dataProvider' => $model->search('UTENSILIO'),
                            'filter' => $model,
