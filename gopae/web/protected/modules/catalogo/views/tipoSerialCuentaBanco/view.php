                        ...
                        <div id="div-datos-generales">
                            ...
                            <div class="widget-box">
                                            ...
                                            <div class="widget-main form">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php echo $form->labelEx($model,'tipo_serial_cuenta_id'); ?>
                                                            <?php echo $form->textField($model,'tipo_serial_cuenta_id', array('class' => 'span-12', 'disabled'=>'disabled',)); ?>
                                                        </div>


                                                        <div class="col-md-4">
                                                            <?php echo $form->labelEx($model,'serial'); ?>
                                                            <?php echo $form->textField($model,'serial',array('size'=>10, 'maxlength'=>10, 'class' => 'span-12', 'disabled'=>'disabled',)); ?>
                                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a class="btn btn-danger" href="<?php echo $this->createUrl("/catalogo/tipoSerialCuentaBanco"); ?>" id="btnRegresar">
