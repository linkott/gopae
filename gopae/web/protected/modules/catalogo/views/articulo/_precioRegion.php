                                ...
                                if ($precioRegion != null) {
                                    foreach ($precioRegion AS $pre) {
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td align="center">
                                                <a title="Modificar Precio" onclick="modificarPrecio(<?php echo base64_decode($_GET['id']); ?>, <?php if ($pre['precio_region_id'] != '') {
                                                echo $pre['precio_region_id'];
                                            } else {
                                                echo 'null';
                                            } ?>, <?php echo $pre['estado_id']; ?>, <?php if ($pre['articulo_id'] != '') {
                                    echo $pre['articulo_id'];
                                } else {
                                    echo 'null';
                                } ?>)" class="fa fa-pencil green"> Modificar</a>
                                            </td>
                                        </tr>
        <?php
    }
