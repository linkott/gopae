...
<div class="col-xs-12">
    <div class="row-fluid">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <?php echo $form->textField($model,'nombre',array('size'=>50, 'maxlength'=>50, 'class' => 'span-12', )); ?>
                                                        </div>
        ...
        <?php
             ...
             *   Yii::app()->request->baseUrl . '/public/js/modules/TipoSerialCuentaController/tipo-serial-cuenta/form.js',CClientScript::POS_END
             *);
             */
        ?>
    </div>
