...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
        array(
            ...
            'name' => 'id',
            'htmlOptions' => array(),
            //'filter' => CHtml::textField('Banco[id]', $model->id, array('title' => '',)),
        ),
        array(
        ...
        array(
            ...
            'name' => 'usuario_ini_id',
            'htmlOptions' => array(),
            //'filter' => CHtml::textField('Banco[usuario_ini_id]', $model->usuario_ini_id, array('title' => '',)),
        ),
        array(
            'header' => '<center>fecha_ini</center>',
            'name' => 'fecha_ini',
            'htmlOptions' => array(),
            //'filter' => CHtml::textField('Banco[fecha_ini]', $model->fecha_ini, array('title' => '',)),
        ),
        array(
            'header' => '<center>usuario_act_id</center>',
            'name' => 'usuario_act_id',
            'htmlOptions' => array(),
            //'filter' => CHtml::textField('Banco[usuario_act_id]', $model->usuario_act_id, array('title' => '',)),
        ),
        array(
            'header' => '<center>fecha_act</center>',
            'name' => 'fecha_act',
            'htmlOptions' => array(),
            //'filter' => CHtml::textField('Banco[fecha_act]', $model->fecha_act, array('title' => '',)),
        ),
		/*
        array(
        ...
        array(
            ...
            'name' => 'estatus',
            'htmlOptions' => array(),
            //'filter' => CHtml::textField('Banco[estatus]', $model->estatus, array('title' => '',)),
        ),
		*/
		array(
                    'type' => 'raw',
