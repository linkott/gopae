    ...
    <div class="row-fluid">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <?php echo $form->textField($model,'codigo',array('size'=>10, 'maxlength'=>10, 'class' => 'span-12', "required"=>"required", )); ?>
                                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <?php echo $form->textField($model,'siglas',array('size'=>10, 'maxlength'=>10, 'class' => 'span-12', "required"=>"required", )); ?>
                                                        </div>
        ...
        <?php
            ...
            Yii::app()->clientScript->registerScriptFile(
                Yii::app()->request->baseUrl . '/public/js/modules/catalogo/tipoCargoNominal/form.js',CClientScript::POS_END
            );
