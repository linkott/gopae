        ...
        <div class="widget-body-inner" style="display: block;">
            <div class="widget-main">
                ...
                <div style="padding-left:10px;" class="pull-right">
                    <a class="btn btn-success btn-next btn-sm" data-last="Finish" href="#" onclick="registrarArticulo('alimento');">
                ...
                <div style="display:block" class="search-form">
                    <div>
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'id' => 'articulo-grid',
                            'dataProvider' => $model->search('ALIMENTO'),
                            'filter' => $model,
...
//                                ),
                                ...
                                array(
                                    'header' => 'Franja',
                                    'name' => 'franja_id',
                                    'value' => '(is_object($data->franja) && isset($data->franja->nombre))? $data->franja->nombre: ""',
                                    'filter' => CHtml::listData(
                                            Franja::model()->findAll(
                                                    array(
                                                        'order' => 'id ASC'
                                                    )
                                            ), 'id', 'nombre'
