...
class UtensilioController extends Controller
{
	...
	public $layout='//layouts/column2';
        static $_permissionControl = array(
            'read' => 'Gestion de Utensilio',
            'write' => 'Gestion de Utensilio',
            'label' => 'Gestion de Utensilio'
        );
...
//            var_dump($model);die();
            ...
            if ($model->validate()) {
                if ($model->save()) {
                    $this->registerLog('ESCRITURA', 'articulo.crear', 'EXITOSO', 'Se creo un nuevo utensilio');
...
//            var_dump($model);
    ...
    //                var_dump(1);die();
            ...
            if ($model->validate()) {
                if ($model->save()) {
                    $this->registerLog('ESCRITURA', 'articulo.procesarCambio', 'EXITOSO', 'Se modifico un utensilio: ' . $id);
...
//        var_dump($nombreArticulo);die();
    ...
    public function actionEliminarArticulo($id) {
        ...
        if ($model != null) {
            ...
            if ($resultadoEliminar == 1) {
                $this->registerLog('ESCRITURA', 'articulo.eliminarArticulo', 'EXITOSO', 'Se inactivo un utensilio: ' . $id);
    ...
    public function actionActivarArticulo($id) {
        ...
        if ($model != null) {
            ...
            if ($resultadoActivar == 1) {
                $this->registerLog('ESCRITURA', 'articulo.activarArticulo', 'EXITOSO', 'Se activo un utensilio: ' . $id);
     ...
     */ {
        ...
        if (($estatus == 'A') || ($estatus == '')) {
            $columna .= '<li>' . CHtml::link("<span style='font-family:Helvetica Neue,Arial,Helvetica,sans-serif;'>&nbsp;&nbsp;Consultar Utensilio</span>", '', array("class" => "fa fa-search-plus", "title" => "Consultar Utensilio", "onClick" => "consultarArticulo($id)")) . '</li>';
            $columna .= '<li>' . CHtml::link("<span style='font-family:Helvetica Neue,Arial,Helvetica,sans-serif;'>&nbsp;&nbsp;Modificar Utensilio</span>", '', array("class" => "fa fa-pencil green", "title" => "Modificar Utensilio", "onClick" => "modificarArticulo($id)")) . '</li>';
            ...
            $columna .= '<li>' . CHtml::link("<span style='font-family:Helvetica Neue,Arial,Helvetica,sans-serif;'>&nbsp;&nbsp;Inactivar Utensilio</span>", '', array("class" => "fa fa-trash-o red", "title" => "Inactivar Utensilio", "onClick" => "eliminarArticulo($id)")) . '</li>';
        } else if ($estatus == 'E') {
            $columna .= '<li>' . CHtml::link("<span style='font-family:Helvetica Neue,Arial,Helvetica,sans-serif;'>&nbsp;&nbsp;Consultar Utensilio</span>", '', array("class" => "fa fa-search-plus", "title" => "Consultar Utensilio", "onClick" => "consultarArticulo($id)")) . '</li>';
            $columna .= '<li>' . CHtml::link("<span style='font-family:Helvetica Neue,Arial,Helvetica,sans-serif;'>&nbsp;&nbsp;Activar Utensilio</span>", '', array("class" => "fa fa icon-ok green", "title" => "Activar Utensilio", "onClick" => "activarArticulo($id)")) . '</li>';
