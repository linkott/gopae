...
class ArticuloController extends Controller
{
	...
	public $layout='//layouts/column2';
        static $_permissionControl = array(
            'read' => 'Gestion de Articulo',
            'write' => 'Gestion de Articulo',
            'label' => 'Gestion de Articulo'
        );
...
//            var_dump($model);die();
            ...
            if ($model->validate()) {
                if ($model->save()) {
                    $this->registerLog('ESCRITURA', 'articulo.crear', 'EXITOSO', 'Se creo un nuevo articulo');
...
//            var_dump($model);
    ...
    //                var_dump(1);die();
            ...
            if ($model->validate()) {
                if ($model->save()) {
                    $this->registerLog('ESCRITURA', 'articulo.procesarCambio', 'EXITOSO', 'Se modifico un articulo: ' . $id);
...
//        var_dump($nombreArticulo);die();
    ...
    public function actionEliminarArticulo($id) {
        ...
        if ($model != null) {
            ...
            if ($resultadoEliminar == 1) {
                $this->registerLog('ESCRITURA', 'articulo.eliminarArticulo', 'EXITOSO', 'Se inactivo un articulo: ' . $id);
    ...
    public function actionActivarArticulo($id) {
        ...
        if ($model != null) {
            ...
            if ($resultadoActivar == 1) {
                $this->registerLog('ESCRITURA', 'articulo.activarArticulo', 'EXITOSO', 'Se activo un articulo: ' . $id);
     ...
     */ {
        ...
        if (($estatus == 'A') || ($estatus == '')) {
            $columna .= '<li>' . CHtml::link("<span style='font-family:Helvetica Neue,Arial,Helvetica,sans-serif;'>&nbsp;&nbsp;Consultar Articulo</span>", '', array("class" => "fa fa-search-plus", "title" => "Consultar articulo", "onClick" => "consultarArticulo($id)")) . '</li>';
            $columna .= '<li>' . CHtml::link("<span style='font-family:Helvetica Neue,Arial,Helvetica,sans-serif;'>&nbsp;&nbsp;Modificar Articulo</span>", '', array("class" => "fa fa-pencil green", "title" => "Modificar articulo", "onClick" => "modificarArticulo($id)")) . '</li>';
            ...
            $columna .= '<li>' . CHtml::link("<span style='font-family:Helvetica Neue,Arial,Helvetica,sans-serif;'>&nbsp;&nbsp;Inactivar Articulo</span>", '', array("class" => "fa fa-trash-o red", "title" => "Inactivar articulo", "onClick" => "eliminarArticulo($id)")) . '</li>';
        } else if ($estatus == 'E') {
            $columna .= '<li>' . CHtml::link("<span style='font-family:Helvetica Neue,Arial,Helvetica,sans-serif;'>&nbsp;&nbsp;Consultar articulo</span>", '', array("class" => "fa fa-search-plus", "title" => "Consultar articulo", "onClick" => "consultarArticulo($id)")) . '</li>';
            $columna .= '<li>' . CHtml::link("<span style='font-family:Helvetica Neue,Arial,Helvetica,sans-serif;'>&nbsp;&nbsp;Activar articulo</span>", '', array("class" => "fa fa icon-ok green", "title" => "Activar articulo", "onClick" => "activarArticulo($id)")) . '</li>';
