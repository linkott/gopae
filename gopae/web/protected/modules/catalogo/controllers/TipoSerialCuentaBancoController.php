...
class TipoSerialCuentaBancoController extends Controller
{
    /**
    ...
    public static $_permissionControl = array(
        'read' => 'Consulta de TipoSerialCuentaBancoController',
        'write' => 'Creación y Modificación de TipoSerialCuentaBancoController',
        'admin' => 'Administración Completa  de TipoSerialCuentaBancoController',
        'label' => 'Módulo de TipoSerialCuentaBancoController'
    );
    ...
    {
        $model=new TipoSerialCuentaBanco('search');
        $model->unsetAttributes();  // clear any default values
        if($this->hasQuery('TipoSerialCuentaBanco')){
            $model->attributes=$this->getQuery('TipoSerialCuentaBanco');
        }
    ...
    public function actionRegistro()
    {
        ...
        {
            $model->attributes=$this->getPost('TipoSerialCuentaBanco');
            if($model->save()){
     ...
     * @return TipoSerialCuentaBanco the loaded model
     * @throws CHttpException
     */
    public function loadModel($id)
    {
        $model=TipoSerialCuentaBanco::model()->findByPk($id);
        if($model===null){
     ...
     * @param TipoSerialCuentaBanco $model the model to be validated
     */
    protected function performAjaxValidation($model)
    {
        if($this->hasPost('ajax') && $this->getPost('ajax')==='tipo-serial-cuenta-banco-form')
        {
    ...
    public function getActionButtons($data) {
        ...
        $columna .= CHtml::link("", "", array("class" => "fa icon-zoom-in", "title" => "Ver datos", 'href' => '/catalogo/tipoSerialCuentaBanco/consulta/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= CHtml::link("", "", array("class" => "fa icon-pencil green", "title" => "Editar datos", 'href' => '/catalogo/tipoSerialCuentaBanco/edicion/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= CHtml::link("", "", array("class" => "fa icon-trash red", "title" => "Eliminar datos", 'href' => '/catalogo/tipoSerialCuentaBanco/eliminacion/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= '</div>';
        return $columna;
    }
