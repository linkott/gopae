...
class TipoCuentaBancoController extends Controller
{
    /**
    ...
    public static $_permissionControl = array(
        'read' => 'Consulta de TipoCuentaBancoController',
        'write' => 'Creación y Modificación de TipoCuentaBancoController',
        'admin' => 'Administración Completa  de TipoCuentaBancoController',
        'label' => 'Módulo de TipoCuentaBancoController'
    );
    ...
    {
        $model=new TipoCuentaBanco('search');
        $model->unsetAttributes();  // clear any default values
        if($this->hasQuery('TipoCuentaBanco')){
            $model->attributes=$this->getQuery('TipoCuentaBanco');
        }
    ...
    public function actionRegistro()
    {
        ...
        {
            $model->attributes=$this->getPost('TipoCuentaBanco');
            if($model->save()){
     ...
     * @return TipoCuentaBanco the loaded model
     * @throws CHttpException
     */
    public function loadModel($id)
    {
        $model=TipoCuentaBanco::model()->findByPk($id);
        if($model===null){
     ...
     * @param TipoCuentaBanco $model the model to be validated
     */
    protected function performAjaxValidation($model)
    {
        if($this->hasPost('ajax') && $this->getPost('ajax')==='tipo-cuenta-banco-form')
        {
    ...
    public function getActionButtons($data) {
        ...
        $columna .= CHtml::link("", "", array("class" => "fa icon-zoom-in", "title" => "Ver datos", 'href' => '/catalogo/tipoCuentaBanco/consulta/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= CHtml::link("", "", array("class" => "fa icon-pencil green", "title" => "Editar datos", 'href' => '/catalogo/tipoCuentaBanco/edicion/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= CHtml::link("", "", array("class" => "fa icon-trash red", "title" => "Eliminar datos", 'href' => '/catalogo/tipoCuentaBanco/eliminacion/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= '</div>';
        return $columna;
    }
