...
class TipoSerialCuentaController extends Controller
{
    /**
    ...
    public static $_permissionControl = array(
        'read' => 'Consulta de TipoSerialCuentaController',
        'write' => 'Creación y Modificación de TipoSerialCuentaController',
        'admin' => 'Administración Completa  de TipoSerialCuentaController',
        'label' => 'Módulo de TipoSerialCuentaController'
    );
    ...
    {
        $model=new TipoSerialCuenta('search');
        $model->unsetAttributes();  // clear any default values
        if($this->hasQuery('TipoSerialCuenta')){
            $model->attributes=$this->getQuery('TipoSerialCuenta');
        }
    ...
    {
        $model=new TipoSerialCuenta;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if($this->hasPost('TipoSerialCuenta'))
        {
            $model->attributes=$this->getPost('TipoSerialCuenta');
            if($model->save()){
     ...
     * @return TipoSerialCuenta the loaded model
     * @throws CHttpException
     */
    public function loadModel($id)
    {
        $model=TipoSerialCuenta::model()->findByPk($id);
        if($model===null){
     ...
     * @param TipoSerialCuenta $model the model to be validated
     */
    protected function performAjaxValidation($model)
    {
        if($this->hasPost('ajax') && $this->getPost('ajax')==='tipo-serial-cuenta-form')
        {
    ...
    public function getActionButtons($data) {
        ...
        $columna .= CHtml::link("", "", array("class" => "fa icon-zoom-in", "title" => "Ver datos", 'href' => '/catalogo/tipoSerialCuenta/consulta/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= CHtml::link("", "", array("class" => "fa icon-pencil green", "title" => "Editar datos", 'href' => '/catalogo/tipoSerialCuenta/edicion/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= '</div>';
        return $columna;
    }
