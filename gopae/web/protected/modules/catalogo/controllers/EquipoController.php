...
class EquipoController extends Controller
{
	...
	public $layout='//layouts/column2';
        static $_permissionControl = array(
            'read' => 'Gestion de Equipo',
            'write' => 'Gestion de Equipo',
...
//            var_dump($model);die();
            ...
            if ($model->validate()) {
                if ($model->save()) {
                    $this->registerLog('ESCRITURA', 'articulo.crear', 'EXITOSO', 'Se creo un nuevo equipo');
...
//            var_dump($model);
    ...
    //                var_dump(1);die();
            ...
            if ($model->validate()) {
                if ($model->save()) {
                    $this->registerLog('ESCRITURA', 'articulo.procesarCambio', 'EXITOSO', 'Se modifico un equipo: ' . $id);
    ...
    public function actionEliminarArticulo($id) {
        ...
        if ($model != null) {
            ...
            if ($resultadoEliminar == 1) {
                $this->registerLog('ESCRITURA', 'articulo.eliminarArticulo', 'EXITOSO', 'Se inactivo un equipo: ' . $id);
    ...
    public function actionActivarArticulo($id) {
        ...
        if ($model != null) {
            ...
            if ($resultadoActivar == 1) {
                $this->registerLog('ESCRITURA', 'articulo.activarArticulo', 'EXITOSO', 'Se activo un equipo: ' . $id);
