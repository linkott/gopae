...
class EmpresaController extends Controller
{
    ...
    public static $_permissionControl = array(
        'read' => 'Consulta de EmpresaController',
        'write' => 'Creación y Modificación de EmpresaController',
        'admin' => 'Administración Completa  de EmpresaController',
        'label' => 'Módulo de EmpresaController'
    );
    ...
    public function actionLista()
    {
        ...
        if($this->hasQuery('Empresa')){
            $model->attributes=$this->getQuery('Empresa');
        }
    ...
    public function actionRegistro()
    {
        ...
        if($this->hasPost('Empresa'))
        {
            $model->attributes=$this->getPost('Empresa');
            if($model->save()){
    ...
    {
        if($this->hasPost('ajax') && $this->getPost('ajax')==='empresa-form')
        {
    ...
    public function getActionButtons($data) {
        ...
        $columna .= CHtml::link("", "", array("class" => "fa icon-zoom-in", "title" => "Ver datos", 'href' => '/administracion/empresa/consulta/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= CHtml::link("", "", array("class" => "fa icon-pencil green", "title" => "Editar datos", 'href' => '/administracion/empresa/edicion/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= '</div>';
        return $columna;
    }
