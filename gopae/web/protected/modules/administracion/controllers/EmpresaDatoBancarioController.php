...
class EmpresaDatoBancarioController extends Controller
{
    /**
    ...
    public static $_permissionControl = array(
        'read' => 'Consulta de EmpresaDatoBancarioController',
        'write' => 'Creación y Modificación de EmpresaDatoBancarioController',
        'admin' => 'Administración Completa  de EmpresaDatoBancarioController',
        'label' => 'Módulo de EmpresaDatoBancarioController'
    );
    ...
    {
        $model=new EmpresaDatoBancario('search');
        $model->unsetAttributes();  // clear any default values
        if($this->hasQuery('EmpresaDatoBancario')){
            $model->attributes=$this->getQuery('EmpresaDatoBancario');
        }
    ...
    {
        $model=new EmpresaDatoBancario;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if($this->hasPost('EmpresaDatoBancario'))
        {
            $model->attributes=$this->getPost('EmpresaDatoBancario');
            if($model->save()){
     ...
     * @return EmpresaDatoBancario the loaded model
     * @throws CHttpException
     */
    public function loadModel($id)
    {
        $model=EmpresaDatoBancario::model()->findByPk($id);
        if($model===null){
     ...
     * @param EmpresaDatoBancario $model the model to be validated
     */
    protected function performAjaxValidation($model)
    {
        if($this->hasPost('ajax') && $this->getPost('ajax')==='empresa-dato-bancario-form')
        {
    ...
    public function getActionButtons($data) {
        ...
        $columna .= CHtml::link("", "", array("class" => "fa icon-zoom-in", "title" => "Ver datos", 'href' => '/empresa/empresaDatoBancario/consulta/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= CHtml::link("", "", array("class" => "fa icon-pencil green", "title" => "Editar datos", 'href' => '/empresa/empresaDatoBancario/edicion/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= CHtml::link("", "", array("class" => "fa icon-trash red", "title" => "Eliminar datos", 'href' => '/empresa/empresaDatoBancario/eliminacion/id/'.$id)) . '&nbsp;&nbsp;';
        $columna .= '</div>';
        return $columna;
    }
