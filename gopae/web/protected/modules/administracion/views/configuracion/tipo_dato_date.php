<?php //$resultado=  Configuracion::model()->Casos();?>
<?php //foreach ($resultado as $datos){?>
<?php //if($datos['nombre']=="ASIGNACION_TITULO"){
   // var_dump($datos['valor_date']); die();
//}
?>
                    ...
                    <td>
                        <div class="profile-info-row">
                            <div class="profile-user-info profile-user-info-striped">
                                ...
                                <div class="profile-info-value">
                               <?php echo $form->textField($model,'valor_date', array('size' => 10, 'maxlength' => 10, 'id' => 'valor_date', 'style' => 'width:200px', 'readOnly' => 'readOnly')); ?>
                                </div>
                            </div>
                        </div>
