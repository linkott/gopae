...
<table>
    <caption style="font-size: 15px; margin-left: 5px;"> Información de la Configuración </caption>
    <tr>
            ...
            <td>
                <div class="profile-info-row">
                    <div class="profile-user-info profile-user-info-striped">
                        ...
                        <div class="profile-info-value">
                            <?php if($model->valor_bool==1): $variable_valor="si"?>
                            <span id="estado"><?php echo CHtml::encode($variable_valor); ?></span>
                            <?php endif;?>
                            <?php if($model->valor_bool==0):  $variable_valor="no"?>
                            <span id="valor"><?php echo CHtml::encode($variable_valor); ?></span>
                            <?php endif;?>
                        </div>
                    </div>
                </div>
            ...
            <td>
                <div class="profile-info-row">
                    <div class="profile-user-info profile-user-info-striped">
                        ...
                        <div class="profile-info-value">
                            <?php $fecha=date('d-m-Y',strtotime($model->valor_date));?>
                            <span id="valor"><?php echo CHtml::encode($fecha); ?></span>
                        </div>
                    </div>
                </div>
            </td>
