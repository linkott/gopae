<input type="hidden" id="tipo-formulario" name="configuracion" value="tipo_bool" />
<?php
...
<div id="validaciones">
    <div class="infoDialogBox">
        <p>
            Debe seleccionar el tipo de valor que desea cambiar
        </p>
    </div>
</div>
            ...
            <table>
                ...
                <input type="hidden" id='id'  name="id" value="<?php echo base64_encode($model->id); ?>" />
                    ...
                    <td>
                        <div class="profile-info-row">
                            <div class="profile-user-info profile-user-info-striped">
                                <div class="profile-info-name"><b><i>Bool</i></b></div>
                                <div class="profile-info-value">
                                    <span>  <?php
                                     echo $form->dropDownList($model,'valor_bool', array('0'=>'no','1'=>'si'), array('style'=>'width:7%;'));?>
                                </span>
                            </div>
                        </div>
                        </div>
