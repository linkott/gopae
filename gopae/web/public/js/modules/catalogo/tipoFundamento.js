...
accion=accion;
                ...
                title_html: true,
                        ...
                        {   
                            ...
                            click: function() {
                                ...
                                var urlDir = "/catalogo/tipoFundamento/"+accion+"/"+id;
                                var datos = $("#tipo-fundamento-form").serialize();
                                var conEfecto = true;
                                var showHTML = true;
                                var method = "POST";
    ...
    $.ajax({
        ...
        Loading.hide();
         ...
         $("#dialogPantalla").html('<div class="alert alert-warning"> ¿Desea inactivar este tipo de fundamento Juridico?</div>');
        ...
        },
        {
            ...
            click: function() {
                            ...
                            var urlDir = "/catalogo/tipoFundamento/"+accion+"/";
        ...
        Loading.hide();
         ...
         $("#dialogPantalla").html('<div class="alertDialogBox"><p class="bolder center grey"> ¿Desea habilitar este Tipo de Fundamento Juridico? </p></div>');
...
function cambiarEstatus(){
   ...
   var id = $("id").val();
    ...
    var dialog = $("#dialogPantalla").removeClass('hide').dialog({
        ...
        dragable: false,
        resizable: false,
        title: "<div class='widget-header widget-header-small'><h4 class='smaller'><i class='fa fa-exclamation-triangle'></i> Eliminar este tipo fundamento juridico</h4></div>",
        title_html: true,
        buttons: [
            {
                html: "<i class='icon-remove bigger-110'></i>&nbsp; Cancelar",
            ...
            {
                html: "<i class='icon-trash bigger-110'></i>&nbsp; Eliminar tipo Fundamento Juridico",
                "class": "btn btn-danger btn-xs",
                click: function() {
                    executeAjax('_borrar', '/catalogo/tipoFundamento/borrar', data, false, true, 'POST', 'html');
                   // $(this).dialog("close");
                }
            }
        ]
