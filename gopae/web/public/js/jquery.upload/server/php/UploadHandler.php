...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        3 => 'El archivo fue subido sólo parcialmente',
        ...
        'accept_file_types' => 'Tipo de archivo no aceptado',
        'max_number_of_files' => 'Maximum number of files exceeded',
        'max_width' => 'Image exceeds maximum width',
        'min_width' => 'Image requires a minimum width',
        'max_height' => 'Image exceeds maximum height',
        'min_height' => 'Image requires a minimum height',
        'abort' => 'Carga de archivo abortada',
        'image_resize' => 'Error al cambiar el tamaño de la imagen'
    );

    protected $image_objects = array();
/*AQUI MODIFICAMOS LAS ESPECIFICACIONES DEL DIRECTORIO DONDE SE VA A PONER LOS ARCHIVOS*/
    function __construct($options = null, $initialize = true, $error_messages = null, $path= null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/public/uploads/',
            'upload_url' => $this->get_full_url().'/public/uploads/',
            'user_dirs' => false,
            'mkdir_mode' => 777,
            'param_name' => 'files',
            ...
            'inline_file_types' => '/\.(jpe?g|png|pdf|doc|opt)$/i',/*ALEXIS TIPO DE ARCHIVOS ACEPTADOS*/
            ...
            'image_file_types' => '/\.(jpe?g|png|pdf|doc|opt)$/i',
