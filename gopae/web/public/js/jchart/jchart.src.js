...
function error(code, stop) {
	var msg = 'jchart error #' + code + ': www.jchart.free/errors/' + code;
	if (stop) {
		throw msg;
	} else if (win.console) {
		console.log(msg);
...
defaultOptions = {
	...
	lang: {
		...
		weekdays: ['Domingo', 'Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viérnes', 'Sábado'],
		decimalPoint: '.',
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: '/public/js/modules/canvas-tools.js',
		VMLRadialGradientURL: '/public/images/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
