...
(function(c) {
    PNotify.prototype.options.buttons = {closer: !0, closer_hover: !0, sticker: !0, sticker_hover: !0, labels: {close: "Cerrar", stick: "Mantener"}};
    PNotify.prototype.modules.buttons = {myOptions: null, closer: null, sticker: null, init: function(a, b) {
            var d = this;
            this.myOptions = b;
...
(function(a){var c,f;a(function(){a("body").on("pnotify.history-all",function(){a.each(PNotify.notices,function(){this.modules.history.inHistory&&(this.elem.is(":visible")?this.options.hide&&this.queueRemove():this.open&&this.open())})}).on("pnotify.history-last",function(){var a="top"===PNotify.prototype.options.stack.push,b=a?0:-1,d;do{d=-1===b?PNotify.notices.slice(b):PNotify.notices.slice(b,b+1);if(!d[0])return!1;b=a?b+1:b-1}while(!d[0].modules.history.inHistory||d[0].elem.is(":visible"));d[0].open&&
    ...
    PNotify.prototype.options.history = {history: !0, menu: !1, fixed: !0, maxonscreen: Infinity, labels: {redisplay: "Volver a mostrar", all: "Todo", last: "Último"}};
    PNotify.prototype.modules.history = {inHistory: !1, init: function(e, b) {
            e.options.destroy = !1;
            this.inHistory = b.history;
            if (b.menu && "undefined" === typeof c) {
                c = a("<div />", {"class": "ui-pnotify-history-container " + e.styles.hi_menu, mouseleave: function() {
                        c.animate({top: "-" + f + "px"}, {duration: 100, queue: !1})
                    }}).append(a("<div />", {"class": "ui-pnotify-history-header",
...
(function(c) {
    PNotify.prototype.options.reference = {putThing: !1, labels: {text: "Girar"}};
    PNotify.prototype.modules.reference = {thingElem: null, init: function(b, a) {
            var d = this;
            a.putThing && (this.thingElem = c('<button style="float:right;" class="btn btn-default" type="button" disabled><i class="' + b.styles.athing + '" />&nbsp;' + a.labels.text + "</button>").appendTo(b.container), b.container.append('<div style="clear: right; line-height: 0;" />'), b.elem.on({mouseenter: function(b) {
